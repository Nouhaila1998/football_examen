...
public class MatchServiceControler {
    ...
    {
Match match1 = new Match(1L, "RS vs B", 1L, 2L);
        Match match2 = new Match(2L, "BM vs MU", 3L, 4L);
        Match match3 = new Match(3L, "JV vs BM", 1L, 3L);
          Match match5 = new Match(5L, "BRC vs MC", 4L, 2L);
